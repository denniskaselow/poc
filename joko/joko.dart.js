...
"%":"CanvasRenderingContext|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|TextMetrics"},
kn:{
"":"bool/Gv;",
...
UM:{
"":"tp;fg:height=,R:width=",
"%":"SVGUseElement"}}],["dart.typed_data","dart:typed_data",,P,{
"":"",
HY:{
"":"Gv;",
...
return}throw "Unable to print message: " + String(a)}}],["","file:///F:/Programming/workspaces/dart/poc/web/joko/joko.dart",,O,{
"":"",
Iq:[function(){var z=J.uX($.yJ())
...
O.pn()},"call$0","eE",0,0,1],
pn:function(){var z,y,x,w,v
z=J.Vm($.p3())
y=$.H9().measureText(z).width
x=H.Hp(J.Vm($.BC()),null,null)
w=$.jY()
v=J.RE(w)
v.sR(w,J.WB(x,50))
v.sfg(w,J.XH(J.WB(J.p0(H.IH(J.Vm($.yJ()),null),1.2),0.5)))
if(typeof y!=="number")return y.D()
if(typeof x!=="number")return H.s(x)
if(y>x)J.LX($.p3().style,"#CC1234")
else J.LX($.p3().style,"#12CC34")
w=$.H9()
v=$.jY()
w.clearRect(0,0,J.DO(v),J.OB(v))
w.font=H.d(J.Vm($.yJ()))+"px Verdana"
w.textBaseline="top"
w.fillText(z,0,0)},
em:{
"":"Tp:11;",
call$1:function(a){J.uP($.jY()).font=H.d(J.Vm($.yJ()))+"px Verdana"
O.pn()}},
Lb:{
"":"Tp:11;",
call$1:function(a){return O.pn()}},
QA:{
"":"Tp:11;",
call$1:function(a){return O.pn()}},
Cv:{
"":"Tp:11;",
call$1:function(a){J.vP(document.querySelector("#container").style,H.d(J.Vm($.BC()))+"px")
O.pn()}}},1],])
...
I.$lazy($,"sizeElem","nj","yJ",function(){return document.querySelector("#size")})
I.$lazy($,"lineLengthElem","uC","BC",function(){return document.querySelector("#lineLength")})
I.$lazy($,"contentElem","TR","p3",function(){return document.querySelector("#content")})
I.$lazy($,"canvas","qN","jY",function(){return document.querySelector("canvas")})
I.$lazy($,"ctx","Ee","H9",function(){return J.uP($.jY())})

init.functionAliases={}
init.metadata=[{func:"zx",args:[J.O]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
